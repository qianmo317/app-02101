    ...
    <section class="section">
      ...
      <div v-else class="song-list">
        ...
        >
          ...
          >
            <svg v-if="favoritesStore.isFavorite(song.id)" viewBox="0 0 24 24" fill="currentColor">
...
function handleToggleFavorite(song) {
  ...
  const isFav = favoritesStore.isFavorite(song.id)
  toast.info(isFav ? '已添加到收藏' : '已取消收藏')
}
